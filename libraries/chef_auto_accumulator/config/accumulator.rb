  ...
  module Config
    ...
    module Accumulator
      ...
      def accumulator_config_path_contained_nested?
        ...
        log_chef(:warn) { "Path tuple option_config_path_match_key: #{debug_var_output(option_config_path_match_key)}"}
        log_chef(:warn) { "Path tuple option_config_path_match_value: #{debug_var_output(option_config_path_match_value)}"}
        log_chef(:warn) { "Path tuple option_config_path_contained_key: #{debug_var_output(option_config_path_contained_key)}"}
